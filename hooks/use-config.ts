...
export function useConfig(): AppConfig {
  const [config, setConfig] = useState<AppConfig>({
    ...
    faviconUrl: configCache?.faviconUrl || '/branding/sigil-favicon.svg',
    appLogoLightUrl: configCache?.appLogoLightUrl || '/branding/sigil-logo.svg',
    appLogoDarkUrl: configCache?.appLogoDarkUrl || '/branding/sigil-logo.svg',
    loginLogoLightUrl: configCache?.loginLogoLightUrl || '/branding/sigil-logo.svg',
    loginLogoDarkUrl: configCache?.loginLogoDarkUrl || '/branding/sigil-logo.svg',

...
export const CONFIG_ENV_MAP: Record<string, { envVar: string; fileEnvVar?: string; type: 'string' | 'boolean' | 'url' | 'enum' | 'json'; defaultValue: unknown; enumValues?: string[] }> = {
  ...
  faviconUrl: { envVar: 'FAVICON_URL', type: 'url', defaultValue: '/branding/sigil-favicon.svg' },
  ...
  pwaThemeColor: { envVar: 'PWA_THEME_COLOR', type: 'string', defaultValue: '#0D1B5E' },
  pwaBackgroundColor: { envVar: 'PWA_BACKGROUND_COLOR', type: 'string', defaultValue: '#0D1B5E' },
  appLogoLightUrl: { envVar: 'APP_LOGO_LIGHT_URL', type: 'url', defaultValue: '/branding/sigil-logo.svg' },
  appLogoDarkUrl: { envVar: 'APP_LOGO_DARK_URL', type: 'url', defaultValue: '/branding/sigil-logo.svg' },
  loginLogoLightUrl: { envVar: 'LOGIN_LOGO_LIGHT_URL', type: 'url', defaultValue: '/branding/sigil-logo.svg' },
  loginLogoDarkUrl: { envVar: 'LOGIN_LOGO_DARK_URL', type: 'url', defaultValue: '/branding/sigil-logo.svg' },

  ...
  return NextResponse.json(
    {
      ...
      faviconUrl: branded<string>('faviconUrl', '/branding/sigil-favicon.svg'),
      appLogoLightUrl: branded<string>('appLogoLightUrl', '/branding/sigil-logo.svg'),
      appLogoDarkUrl: branded<string>('appLogoDarkUrl', '/branding/sigil-logo.svg'),
      loginLogoLightUrl: branded<string>('loginLogoLightUrl', '/branding/sigil-logo.svg'),
      loginLogoDarkUrl: branded<string>('loginLogoDarkUrl', '/branding/sigil-logo.svg'),
